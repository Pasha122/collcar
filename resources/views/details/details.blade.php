...
<div class="container main-container">
	<style type="text/css">
		...
		<div class="my-detail">
			...
			<button id="my-custom-butt" style="float: right;" onclick="window.location='/detail/create'">Створити</button>
			@if($details->isEmpty())
	              ...
	              <tr>
							    ...
							    <td>
							    	<div class="icon-operation">
							    		...
							    		<a href="/detail/edit/{{$detail->id}}"><img src="/img/edit.svg"></a>
							    		<a href="/detail/delete/{{$detail->id}}" onclick="return confirm('Ви дійсно хочете видалити цю запчастину?')"><img src="/img/delete.svg"></a>
							    	</div>
							    </td>
							  </tr>	
	        @endforeach 
