...
<div class="container main-container">
	<style type="text/css">
		...
		<div class="my-brand">
			...
			<button id="my-custom-butt" style="float: right;" onclick="window.location='/brand/create'">Створити</button>
  					...
  					<tr> 
					    ...
					    <td>
					    	<div class="icon-operation">
					    		<a href="/brand/delete/{{$br->id}}" onclick="return confirm('Ви дійсно хочете видалити цю марку авто?')"><img src="/img/delete.svg"></a>
					    	</div>
					    </td>
				  	</tr>	
	        		@endforeach 
